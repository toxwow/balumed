...
<div class="title-header">
    <h3>Usługi</h3>
    <div class="actions">
        <a href="{{route('uslugi.create')}}" class="btn btn-primary"><i class="lni lni-plus"></i> Dodaj nową usługę</a>
    </div>
</div>
@if (session('status'))
    ...
    <table class="table ">
        ...
        @foreach($services as $key => $service)
            <tr>
                ...
                <td><select class="form-control change" data-attribute="status" data-id="{{$service->id}}" data-slug="{{$service->slug}}">
