...
@section('content')
    ...
    <div class="box-wrapper">
        ...
        @endif
        <form name="blogAdd"  action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="title" placeholder="Wpisz tytuł bloga" value="{{ old('title') }}">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="slug">Slug</label>
                        <input type="text" class="form-control" name="slug" id="slug" placeholder="Podaj adres bloga" value="{{ old('slug') }}">
                    </div>
                </div>
                <div class="col-2">
                    <div class="form-group">
                        <label for="services">Tag bloga</label>
                ...
                <div class="col-1">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="status" name="status">
                            ...
                            <option {{ old('status') == 2 ? "selected" : "" }} value="2">Zaarchizowany</option>
                        </select>
                    </div>
                </div>
            </div>
